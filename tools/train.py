...
def parse_args():
    ...
    # parser.add_argument('--config', default=r'D:\RSPrompter-cky\configs\rsprompter\rsprompter_anchor_zhejiang_config.py',
    #                     help='train config file path')
    parser.add_argument('--config', default=r'D:\RSPrompter-cky\configs\rsprompter\rsprompter_anchor_bijie_config.py',
                        help='train config file path')
    # parser.add_argument('--config', default=r'D:\RSPrompter-cky\configs\rsprompter\rsprompter_query_whu_config.py',
    #                     help='train config file path')
    # parser.add_argument('--config', default=r'D:\RSPrompter-cky\configs\rsprompter\rsprompter_anchor_bijie_dem_config.py',
    #                     help='train config file path')
    # parser.add_argument('--config', default=r'D:\RSPrompter-cky\configs\rsprompter\mask2former_whu_config.py
    #                     help='train config file path')
...
def main():
    ...
    if args.work_dir is not None:
        ...
        cfg.trainer_cfg['default_root_dir'] = osp.join('./work_dirs', osp.spliniaidetext(osp.basename(args.config))[0])
    if args.is_debug:
