...
def parse_args():
    ...
    # parser.add_argument('--config', default=r'D:\RSPrompter-cky\configs\rsprompter\maskrcnn_whu_config.py', help='train config file path')
    parser.add_argument('--ckpt-path', default=r"D:\RSPrompter-cky\tools\results\zhejiang_june_samus_ins\E20230629_rgbdem_center\checkpoints\epoch_epoch=14-map_valsegm_map_0=0.0390.ckpt",
