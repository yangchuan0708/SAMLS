...
task_name = 'zhejiang_mask2former_ins'
exp_name = 'E20230525_2024_center_p'
logger = dict(
    type='WandbLogger',
    project=task_name,
    group='mask2former',
...
train_data_prefix = 'train2024c/'
val_data_prefix = 'test2024c/'
...
val_loader = dict(
        ...
        dataset=dict(
            ...
            data_prefix=dict(img_path=val_data_prefix + '/image3', seg_path=val_data_prefix + '/label'),
            test_mode=True,
...
datamodule_cfg = dict(
    ...
    train_loader=dict(
        ...
        dataset=dict(
            ...
            data_prefix=dict(img_path=train_data_prefix + '/image3', seg_path=train_data_prefix + '/label'),
            filter_cfg=dict(filter_empty_gt=False, min_size=32),
