...
task_name = 'bijie_rgbd_samus_query'
...
test_pipeline = [
    dict(type='mmdet.LoadImageFromFile', backend_args=backend_args, imdecode_backend='tifffile'),
    dict(type='mmdet.Resize', scale=image_size),
...
data_parent = r'D:/RSPrompter-cky/data/bijie_rgbd'
